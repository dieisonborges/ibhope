...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{ asset('site/css/grayscale.min.css') }}" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
          <img src="{{ asset('logo/logo-960x960-transparent.png') }}" width="100px" alt="HOPE - Igreja Batista">
        </a>
    ...
    <!-- About Section -->
    <section id="nossahistoria" class="about-section text-center">
      <div class="container">
        <div class="row">
        ...
        <div class="row align-items-center no-gutters mb-4 mb-lg-5">
          ...
          <div class="col-xl-4 col-lg-5">
            <div class="featured-text text-center text-lg-left">
              <h4>Nós cremos</h4>
              <p class="text-black-50 mb-0">Entenda a visão geral e individual de Deus para a nossa igreja.</p>
            </div>
          </div>
        </div>
    ...
    <!-- Signup Section -->
    <section id="doacoes" class="projects-section bg-light">
      <div class="container">
        ...
        <div class="row align-items-center no-gutters mb-4 mb-lg-5">          
          ...
          <div class="col-xl-6 col-lg-5">
            <img class="img-fluid mb-3 mb-lg-0" src="{{ asset('site/img/bg-trigo.jpg') }}" alt="">
          </div>
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-200">
              <div class="card-body text-center">
                <i class="fa fa-piggy-bank text-primary mb-2"></i>
                <h4 class="text-uppercase m-0">Seja Nosso Parceiro Ministerial</h4>
                <hr class="my-4">
                <div class="small text-black-20">Faça sua contribuição voluntária e seja abençoador de vidas.</div>
                <br>
        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                <i class="fa fa-clock text-primary mb-2"></i>
                <h4 class="text-uppercase m-0">Programação</h4>
                <hr class="my-4">
                <div class="small text-black-20">Abaixo a nossa programação:</div>
                <br>
                  <p class="small text-black-50 text-left">
                    <span class="fa fa-church"></span> Cultos aos Domingos às <b>18:00</b>
                    <br><br>
    ...
    <section class="contact-section bg-black">
      <div class="container">
            ...
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                ...
                <div class="small text-black-50">
                  Pr. Jonas Serra <br>
                  <a href="#">prjonas@ibhope.com.br</a>
                  <br><br>
                  Atendimento <br>
                   <a href="#">contato@ibhope.com.br</a>
                  <br><br>
                  Secretaria <br>
                   <a href="#">secretaria@ibhope.com.br</a>
                  <br><br>
                  Financeiro <br>
                   <a href="#">financeiro@ibhope.com.br</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                ...
                <hr class="my-4">
                <div class="small text-black-50">Pr. Jonas Serra <br><phone>+55 (41) 99590-2045</phone></div>
                <br>
                <div class="small text-black-50">Dieison Borges (Tesouraria) <br><phone>+55 (41) 99581-4222</phone></div>
                <br>
                <div class="small text-black-50">Secretaria <br><phone>+55 (41) 3149-4222</phone></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="social d-flex justify-content-center">          
          <a href="https://www.facebook.com/hopeigrejabatista/" class="mx-2" target="_blank">
    ...
    <script src="{{ asset('site/js/grayscale.min.js') }}"></script>
